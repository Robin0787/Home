...
const ConfirmModal = ({ openModal, setOpenModal, modalHandler }) => {
  return (
      ...
      >
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-[350px] transform overflow-hidden rounded-[12px] text-white  text-left transition-all home">
                <div className="w-full h-inherit rounded-[12px] bg-white/20 py-8">
                  <Dialog.Title
                    as="h3"
